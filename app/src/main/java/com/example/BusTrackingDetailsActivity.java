...
public class BusTrackingDetailsActivity extends AppCompatActivity {
    private String[][] HOSPITAL_URL = {
            {"Vehicle 1: RoadWays", "https://www.redbus.in/online-booking/uttar-pradesh-state-road-transport-corporation-upsrtc", "", "", ""},
            {"Vehicle 2: Rapido", "https://www.rapido.bike/", "", "", ""},
            {"Vehicle 3: E-Bus", "https://www.redbus.in/travels/e-bus-india", "", "", ""},
            {"Vehicle 4: Train", "https://www.irctc.co.in/nget/", "", "", ""},
