...
dependencies {
    ...
    implementation ("com.squareup.okhttp3:okhttp:4.9.3")
        ...
        implementation("com.google.code.gson:gson:2.9.0") // Add Gson dependency
        implementation("org.jetbrains.kotlinx:kotlinx-coroutines-android:1.6.4") // Add coroutines dependency
